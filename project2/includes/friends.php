...
<body class="home header-has-img loading">
    ...
    <div class="wrapper" >
        <header class="header" >
            <div class="head-bg" style="background-image:url(../images/friend.jpeg);"></div>
        ...
        <div class="content" >
            <div class="container" >
				...
				<!-- START: PAGE CONTENT -->
				<section id="about" class="section section-about" style="height:500px;">
            ...
            <div class='col-md-12 col-md-offset-0'>
              <div class='form-group'>
                ...
                <button type='submit' name='browse' class='btn btn-danger' style="position:absolute; top:-5px; right:	440px; height:55px; ">Search</button>
				        ...
				        <section id='experiencee'  class='section section-blog' style='margin-top:-140px;'>
				        ...
				        <?php
				                    ...
				                    if (isset($_POST['browse'])) {
				                      ...
				                      $search = $_POST['search'];
				                      $city   = "country = '$search'";
				                      $quary = "SELECT * from`identity` WHERE $city AND user_id <> '$session' AND authority <> '$admin'  ";
				            ...
				            <article class='post-box'>
				                <div class='post-media'>
				                    <div class='post-image'>
				                        <a href='includes/profile_person.php?id=$data[0]&name=$data[1]'><img src='../images/profiles/$data[4]' alt=''> </a>
				                    </div>
				                </div>
				                ...
				                <div class='post-data'>
				                    ...
				                    <h3 class='post-title'>
				                        <a href='profile_person.php?id=$data[0]&name=$data[1]'>".$data[1]."</a>
				                    </h3>
				        ...
				        ";
									...
									$session = $_SESSION['user_id'];
									$admin = 'admin';
				          $quary = "SELECT * FROM `identity` WHERE user_id <> '$session' AND authority <> '$admin'";
				          $do    = mysqli_query($LINK,$quary);
				          while ($data = mysqli_fetch_array($do)) {
				        ...
				        <div class='grid-item'>
				            <article class='post-box'>
				                <div class='post-media'>
				                    <div class='post-image'>
				                        <a href='profile_person.php?id=$data[0]&name=$data[1]'><img src='../images/profiles/$data[4]' alt=''> </a>
				                    </div>
				                </div>
