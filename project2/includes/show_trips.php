...
<body class="home header-has-img loading">
    ...
    <div class="wrapper" >
        <header class="header" >
            <div class="head-bg" style="background-image:url(../images/farmhouse.jpeg);"></div>
              ...
              <div class='form-group'>
				...
				<?php
										...
										if (isset($_POST['browse'])) {
											...
											$search = $_POST['search'];
											$city   = "city = '$search'";
											$quary = "SELECT * from`trips` WHERE $city ";
						...
						<article class='post-box'>
								<div class='post-media'>
										<div class='post-image'>
												<a href='profile_trip.php?id=$data[0]'><img src='../images/trips/$data[3]' alt=''> </a>
										</div>
								</div>
								...
								<div class='post-data'>
										...
										<h3 class='post-title'>
												<a href='profile_trip.php?id=$data[0]'>".$data[2]."</a>
										</h3>
