...
<body class="home header-has-img loading">
	<?php
			...
			$places   = mysqli_query($LINK,$quary);
					...
					<div class="animate-up">
						<div class="section-box">
							<div class="profile">
								<div class="row">
									<div class="col-xs-5">
										<div class="profile-photo"><img src="../images/places/<?php echo $place[5]; ?>" alt="<?php echo $place[8]; ?>"/></div>
									</div>
									<div class="col-xs-7">
										<div class="profile-info">
											<div class="profile-preword"><span>£&nbsp<?php echo $place[7]; ?></span></div>
											<h1 class="profile-title"><span></span> <?php echo $place[2]; ?></h1>
											<h2 class="profile-position"></h2></div>
                                            <ul class="profile-list">
                                                <li class="clearfix">
                                                    <strong class="title">Place size</strong>
                                                    <span class="cont">
																												<?php echo $place[3]; ?>
                                                    </span>
                                                </li>
                                                <li class="clearfix">
                                                    ...
                                                    <span class="cont"><?php echo $place[8]; ?></span>
                                                </li>
																								<li class="clearfix">
                                                    <strong class="title">Owner</strong>
                                                    <span class="cont">
																											<?php
																														$f= "SELECT * FROM `identity` WHERE user_id=$place[1]";
                                                    ...
                                                    <span class="cont"><?php echo $place[9]; ?></span>
                                                </li>
                                                ...
                                                <li class="clearfix">
                                                    ...
                                                    if($_SESSION['outh'] =="admin") {
                                                        echo "<form action='profile_place.php?id=$id' method='post'> <input type='submit' name='delete' value=DELETE></form>";


                                                        if (isset($_POST['delete'])) {
                                                            $delete = "DELETE FROM `place` WHERE `place`.`place_id` = $id;";
