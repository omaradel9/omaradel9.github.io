...
<body class="home header-has-img loading">
  ...
  <?php
      $id      = $_GET['id'];
			$uname      = $_GET['name'];
      include 'config.php';
      $quary   = "SELECT * FROM `identity` WHERE user_id = $id";
      $persons   = mysqli_query($LINK,$quary);
        ...
        <div class="mobile-nav-inner">
            <nav id="mobile-nav" class="nav">
				<ul class="clearfix">
					...
					<li><a href="chat.php?id=<?echo $id;?> & name=<?php echo $uname; ?>">Contact <span></span></a></li>
                            ...
                            <div class="nav-wrap">
                                <nav id="nav" class="nav">
									<ul class="clearfix">
										...
										<li><a href="index.html#experience">Skills</a></li>
										<li><a href="index.html#experiencee">Service</a></li>
										<li><a href="chat.php?id=<?php echo $id;?>&name=<?php echo $uname; ?>">Contact <span></span></a></li>
										<li><a href="logout.php">Logout</a></li>
											</ul>
								</nav>
					...
					<div class="animate-up">
						<div class="section-box">
							<div class="profile">
								<div class="row">
									<div class="col-xs-5">
										<div class="profile-photo"><img src="../images/profiles/<?php echo $person[4];?>" alt=""/></div>
									</div>
									<div class="col-xs-7">
										<div class="profile-info">
											<div class="profile-preword"><span>£&nbsp<?php echo $person[14]; ?></span></div>
											<h1 class="profile-title"><span>I'm</span> <?php echo $person[1]; ?></h1>
                                            ...
                                            <ul class="profile-list">
                                                ...
                                                <li class="clearfix">
                                                    ...
                                                    <span class="cont"><?php echo $person[9]; ?></span>
                                                </li>
                                                <li class="clearfix">
                                                    <strong class="title">E-mail</strong>
                                                    <span class="cont"><?php echo $person[3]; ?></span>
                                                </li>

                                                <li class="clearfix">
                                                    <?php
                                                            if($_SESSION['outh'] =="admin") {
                                                                echo "<form action='profile_person.php?id=$id&name=$uname' method='post'> <input type='submit' name='delete' value=DELETE></form>";


                                                                if (isset($_POST['delete'])) {
                                                                    $delete = "DELETE FROM `identity` WHERE `identity`.`user_id` = $id;";
