...
<h1>suggestion of your planning <br>
 ...
 if (isset($user_id)){
								...
								<div class='col-lg-7 col-md-10 mt-3 '>
                                    <div class='card' style='width: 20rem;'>
                                     <img class='card-img-top' src='img/$data[4]'alt='Card image cap'>
                                      <div class='card-body'>
                                      <h4 class='Plane 1'>Day $count</h4>
                                      <h4 class='Plane 1'>$data[1]</h4>
                                         <p class='card-text'>$data[5]</p>
                                          <a href='trips.php?id= $data[0]' class='btn btn-primary'>Discover</a>
                                          <a href='map.php?id= $data[0]' class='btn btn-primary'>Show map</a>
                                       </div>
            ...
            `                      </div>
							...
							";
								     ...
								     echo " <h1>we haven't any information about you . </h1>";
                                 }
